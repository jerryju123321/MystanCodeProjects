...
def main():
    """
    This program produces the hangman game with picture for N turns
    """
    life = N_TURNS
    answer = random_word()
    guess = ''
...
def hangman_picture(life):
    """
    This function will gradually produce the hangman picture from the top to the bottom,
    base on the residual life
    """
    count = (N_TURNS - life) * 9 // (N_TURNS - 1) + 2
    for i in range(7):
        print('===', end='')
    print('')
    for i in range(14):
